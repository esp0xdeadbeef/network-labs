{
  ...
  purpose = "FS-970-HDS-010-SDS-010 software design with active-lab runtime artifact validation.";
  smsInputs = {
    "FS-970-HDS-010-SDS-010-SMS-040" = {
      smsRow = ../../SMS/FS-970-HDS-010-SDS-010-SMS-040;
      miniSmtIds = [ "FS-970-HDS-010-SDS-010-SMS-040" ];
