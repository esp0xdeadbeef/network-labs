# SMS Mirror: FS-720-HDS-010-SDS-015-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-720-HDS-010-SDS-015-SMS-010-endpoint-bridge-module.md`
...
The canonical SMS title slug is `endpoint-bridge-module`. Add row-specific lab source and
