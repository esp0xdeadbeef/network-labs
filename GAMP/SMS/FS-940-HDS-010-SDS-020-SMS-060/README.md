# SMS Mirror: FS-940-HDS-010-SDS-020-SMS-060

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-940-HDS-010-SDS-020-SMS-060-route-exception-layer.md`
...
The canonical SMS title slug is `route-exception-layer`. Add row-specific lab source and
