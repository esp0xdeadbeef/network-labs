# SMS Mirror: FS-720-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-720-HDS-010-SDS-010-SMS-010-test-clients-substrate.md`
...
The canonical SMS title slug is `test-clients-substrate`. Add row-specific lab source and
