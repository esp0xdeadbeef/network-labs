# SMS Mirror: FS-330-HDS-010-SDS-010-SMS-020

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-330-HDS-010-SDS-010-SMS-020-preserved-offset-remap.md`
...
The canonical SMS title slug is `preserved-offset-remap`. Add row-specific lab source and
