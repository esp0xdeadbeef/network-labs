# SMS Mirror: FS-380-HDS-020-SDS-010-SMS-060

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-380-HDS-020-SDS-010-SMS-060-core-wan-ip-assignment.md`
...
The canonical SMS title slug is `core-wan-ip-assignment`. Add row-specific lab source and
