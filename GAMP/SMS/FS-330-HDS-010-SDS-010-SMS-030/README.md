# SMS Mirror: FS-330-HDS-010-SDS-010-SMS-030

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-330-HDS-010-SDS-010-SMS-030-identity-diagnostics.md`
...
The canonical SMS title slug is `identity-diagnostics`. Add row-specific lab source and
