# SMS Mirror: FS-670-HDS-010-SDS-010-SMS-030

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-670-HDS-010-SDS-010-SMS-030-tenant-service-policy.md`
...
The canonical SMS title slug is `tenant-service-policy`. Add row-specific lab source and
