# SMS Mirror: FS-680-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-680-HDS-010-SDS-010-SMS-010-shared-service-matrix.md`
...
The canonical SMS title slug is `shared-service-matrix`. Add row-specific lab source and
