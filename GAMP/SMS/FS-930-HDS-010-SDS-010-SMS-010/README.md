# SMS Mirror: FS-930-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-930-HDS-010-SDS-010-SMS-010-failure-diagnostics.md`
...
The canonical SMS title slug is `failure-diagnostics`. Add row-specific lab source and
