# SMS Mirror: FS-570-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-570-HDS-010-SDS-010-SMS-010-namespace-fallback.md`
...
The canonical SMS title slug is `namespace-fallback`. Add row-specific lab source and
