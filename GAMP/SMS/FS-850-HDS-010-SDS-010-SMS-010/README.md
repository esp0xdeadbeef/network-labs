# SMS Mirror: FS-850-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-850-HDS-010-SDS-010-SMS-010-secret-redaction.md`
...
The canonical SMS title slug is `secret-redaction`. Add row-specific lab source and
