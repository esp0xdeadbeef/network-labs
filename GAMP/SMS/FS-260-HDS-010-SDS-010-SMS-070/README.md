# SMS Mirror: FS-260-HDS-010-SDS-010-SMS-070

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-260-HDS-010-SDS-010-SMS-070-nfm-authority-boundary.md`
...
The canonical SMS title slug is `nfm-authority-boundary`. Add row-specific lab source and
