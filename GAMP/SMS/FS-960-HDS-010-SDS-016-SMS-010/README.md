# SMS Mirror: FS-960-HDS-010-SDS-016-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-960-HDS-010-SDS-016-SMS-010-clab-autostart.md`
...
The canonical SMS title slug is `clab-autostart`. Add row-specific lab source and
