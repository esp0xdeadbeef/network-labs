# SMS Mirror: FS-670-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-670-HDS-010-SDS-010-SMS-010-tenant-access-matrix.md`
...
The canonical SMS title slug is `tenant-access-matrix`. Add row-specific lab source and
