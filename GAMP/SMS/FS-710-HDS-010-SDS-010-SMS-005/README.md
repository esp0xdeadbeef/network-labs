# SMS Mirror: FS-710-HDS-010-SDS-010-SMS-005

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-710-HDS-010-SDS-010-SMS-005-lab-site-role-map.md`
...
The canonical SMS title slug is `lab-site-role-map`. Add row-specific lab source and
