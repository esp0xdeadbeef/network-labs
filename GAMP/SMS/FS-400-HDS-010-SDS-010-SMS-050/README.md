# SMS Mirror: FS-400-HDS-010-SDS-010-SMS-050

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-400-HDS-010-SDS-010-SMS-050-ula-wan-denial.md`
...
The canonical SMS title slug is `ula-wan-denial`. Add row-specific lab source and
