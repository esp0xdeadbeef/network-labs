# SMS Mirror: FS-163-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-163-HDS-010-SDS-010-SMS-010-complete-lock-closure.md`
...
The canonical SMS title slug is `complete-lock-closure`. Add row-specific lab source and
