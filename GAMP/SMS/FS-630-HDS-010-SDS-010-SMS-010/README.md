# SMS Mirror: FS-630-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-630-HDS-010-SDS-010-SMS-010-printer-service-class.md`
...
The canonical SMS title slug is `printer-service-class`. Add row-specific lab source and
