# SMS Mirror: FS-750-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-750-HDS-010-SDS-010-SMS-010-receiver-simulation.md`
...
The canonical SMS title slug is `receiver-simulation`. Add row-specific lab source and
