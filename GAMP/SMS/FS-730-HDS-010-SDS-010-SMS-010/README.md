# SMS Mirror: FS-730-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-730-HDS-010-SDS-010-SMS-010-cups-printer-vm.md`
...
The canonical SMS title slug is `cups-printer-vm`. Add row-specific lab source and
