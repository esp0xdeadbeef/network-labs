# SMS Mirror: FS-260-HDS-010-SDS-010-SMS-050

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-260-HDS-010-SDS-010-SMS-050-nfm-boundary-contract.md`
...
The canonical SMS title slug is `nfm-boundary-contract`. Add row-specific lab source and
