# SMS Mirror: FS-560-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-560-HDS-010-SDS-010-SMS-010-namespace-authority.md`
...
The canonical SMS title slug is `namespace-authority`. Add row-specific lab source and
