# SMS Mirror: FS-310-HDS-040-SDS-010-SMS-180

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-310-HDS-040-SDS-010-SMS-180-cpm-inventory-boundary.md`
...
The canonical SMS title slug is `cpm-inventory-boundary`. Add row-specific lab source and
