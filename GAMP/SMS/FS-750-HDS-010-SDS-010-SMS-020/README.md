# SMS Mirror: FS-750-HDS-010-SDS-010-SMS-020

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-750-HDS-010-SDS-010-SMS-020-receiver-payload-ports.md`
...
The canonical SMS title slug is `receiver-payload-ports`. Add row-specific lab source and
