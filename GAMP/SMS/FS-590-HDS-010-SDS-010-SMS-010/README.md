# SMS Mirror: FS-590-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-590-HDS-010-SDS-010-SMS-010-discovery-policy-model.md`
...
The canonical SMS title slug is `discovery-policy-model`. Add row-specific lab source and
