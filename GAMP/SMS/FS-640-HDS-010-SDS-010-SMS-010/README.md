# SMS Mirror: FS-640-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-640-HDS-010-SDS-010-SMS-010-media-service-class.md`
...
The canonical SMS title slug is `media-service-class`. Add row-specific lab source and
