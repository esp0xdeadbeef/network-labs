# SMS Mirror: FS-690-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-690-HDS-010-SDS-010-SMS-010-operator-support-view.md`
...
The canonical SMS title slug is `operator-support-view`. Add row-specific lab source and
