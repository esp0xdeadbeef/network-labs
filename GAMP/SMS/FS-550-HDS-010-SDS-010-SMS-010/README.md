# SMS Mirror: FS-550-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-550-HDS-010-SDS-010-SMS-010-dns-leak-prevention.md`
...
The canonical SMS title slug is `dns-leak-prevention`. Add row-specific lab source and
