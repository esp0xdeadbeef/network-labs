# SMS Mirror: FS-420-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-420-HDS-010-SDS-010-SMS-010-translation-selection.md`
...
The canonical SMS title slug is `translation-selection`. Add row-specific lab source and
