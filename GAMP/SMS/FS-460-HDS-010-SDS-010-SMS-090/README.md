# SMS Mirror: FS-460-HDS-010-SDS-010-SMS-090

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-460-HDS-010-SDS-010-SMS-090-nebula-policy-boundary.md`
...
The canonical SMS title slug is `nebula-policy-boundary`. Add row-specific lab source and
