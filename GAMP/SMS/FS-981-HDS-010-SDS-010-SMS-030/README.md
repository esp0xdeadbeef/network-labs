# SMS Mirror: FS-981-HDS-010-SDS-010-SMS-030

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-981-HDS-010-SDS-010-SMS-030-focused-test-mapping.md`
...
The canonical SMS title slug is `focused-test-mapping`. Add row-specific lab source and
