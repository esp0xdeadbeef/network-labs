...
```bash
tests/run-active-lab-mini-smt.sh FS-166-HDS-010-SDS-010-SMS-900__active-lab-mini-runtime FS-166-HDS-010-SDS-010-SMS-900__active-lab-mini-runtime-p2p FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-nixos-clients FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-clab FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-wireguard FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-nebula
```
...
`SMT FS-166-HDS-010-SDS-010-SMS-900__active-lab-mini-runtime` and local `nixos` lock `56239c47` consumed it. The three
...
`SMT FS-166-HDS-010-SDS-010-SMS-900__active-lab-mini-runtime-p2p`, `network-labs@f9d21d2` completed the renderer-input
...
`SMT FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-nixos-clients`, removed router runtime targets from the endpoint
...
`network-labs@d74172e` selected `SMT FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-wireguard` with a one-target
...
`network-labs@4919505` selected `SMT FS-166-HDS-010-SDS-010-SMS-900__mini-renderer-nebula` with a two-target
