{
  layer = "SIT";
  traceId = "FS-870-HDS-010-SDS-010";
  smsInputs = {
    "FS-870-HDS-010-SDS-010-SMS-010" = {
      smtRow = ../../SMT/FS-870-HDS-010-SDS-010-SMS-010;
    ...
    "FS-870-HDS-010-SDS-010-SMS-020" = {
      smtRow = ../../SMT/FS-870-HDS-010-SDS-010-SMS-020;
    ...
    "FS-870-HDS-010-SDS-010-SMS-030" = {
      smtRow = ../../SMT/FS-870-HDS-010-SDS-010-SMS-030;
