{
  mini-smt.FS-540-HDS-010-SDS-010-SMS-045 = {
    communicationContract = {
      relations = [
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__recursive-client-to-access";
          priority = 100;
          from = {
            kind = "tenant";
        ...
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__local-client-to-access";
          priority = 101;
          from = {
            kind = "tenant";
            name = "local-client";
        ...
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__recursive-client-to-local-dns";
          priority = 91;
          from = {
            kind = "tenant";
            name = "recursive-client";
        ...
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__recursive-client-web-egress";
          priority = 200;
          from = {
            kind = "tenant";
            name = "recursive-client";
    ...
    recursiveDnsIntent = {
      ...
      relations = [
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__recursive-dns-to-core";
          priority = 110;
          from = {
            kind = "service";
            name = "recursive-dns";
        ...
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__recursive-client-to-core";
          priority = 111;
          from = {
            kind = "tenant";
            name = "recursive-client";
        ...
        {
          id = "FS-540-HDS-010-SDS-010-SMS-045__core-dns-to-provider";
          priority = 120;
          from = {
            kind = "service";
            name = "core-dns";
