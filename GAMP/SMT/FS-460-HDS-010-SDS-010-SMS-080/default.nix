{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-460-HDS-010-SDS-010-SMS-080/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-460-HDS-010-SDS-010-SMS-080/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-460-HDS-010-SDS-010-SMS-080/inventory-test-clients.nix";
    };
