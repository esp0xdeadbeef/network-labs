...
uses `intent.nix` as a small active-lab source with one client-to-testnet
relation over the minimal five-node policy path required by NFM. It has no full
active-lab, HAT, SAT, or aggregate renderer dependency.
