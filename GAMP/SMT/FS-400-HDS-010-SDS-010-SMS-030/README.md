# SMT Source Stub: FS-400-HDS-010-SDS-010-SMS-030

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-400-HDS-010-SDS-010-SMS-030-routed-client-gua-mode.md`
...
Title slug: `routed-client-gua-mode`
