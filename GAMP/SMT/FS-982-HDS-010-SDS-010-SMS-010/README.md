# SMT Source Stub: FS-982-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-982-HDS-010-SDS-010-SMS-010-host-configuration-renderer-boundary.md`
...
Title slug: `host-configuration-renderer-boundary`
