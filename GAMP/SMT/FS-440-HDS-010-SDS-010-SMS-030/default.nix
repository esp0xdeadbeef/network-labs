{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-440-HDS-010-SDS-010-SMS-030/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-440-HDS-010-SDS-010-SMS-030/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-440-HDS-010-SDS-010-SMS-030/inventory-test-clients.nix";
    };
