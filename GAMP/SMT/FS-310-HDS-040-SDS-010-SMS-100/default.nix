{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-310-HDS-040-SDS-010-SMS-100/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-310-HDS-040-SDS-010-SMS-100/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-310-HDS-040-SDS-010-SMS-100/inventory-test-clients.nix";
    };
