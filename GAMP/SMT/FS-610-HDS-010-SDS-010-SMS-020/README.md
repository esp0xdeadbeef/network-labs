# SMT Source Stub: FS-610-HDS-010-SDS-010-SMS-020

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-610-HDS-010-SDS-010-SMS-020-discovery-boundary-decision-separation.md`
...
Title slug: `discovery-boundary-decision-separation`
