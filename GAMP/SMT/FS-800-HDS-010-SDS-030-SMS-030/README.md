# SMT Source Stub: FS-800-HDS-010-SDS-030-SMS-030

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-800-HDS-010-SDS-030-SMS-030-hat-source-lock-selection.md`
...
Title slug: `hat-source-lock-selection`
