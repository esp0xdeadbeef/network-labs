# SMT Source Stub: FS-310-HDS-010-SDS-010-SMS-120

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-310-HDS-010-SDS-010-SMS-120-renderer-no-naming-inference.md`
...
Title slug: `renderer-no-naming-inference`
