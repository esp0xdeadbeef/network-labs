{
  ...
  tests = {
    ...
    "FS-100-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-100-HDS-010-SDS-010-SMS-010 construction-only emitter provenance verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-100-HDS-010-SDS-010-SMS-030" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-100-HDS-010-SDS-010-SMS-030 construction-only signed-output source containment verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-100-HDS-010-SDS-010-SMS-050" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-100-HDS-010-SDS-010-SMS-050 construction-only output artifact baseline binding verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-110-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-110-HDS-010-SDS-010-SMS-010 construction-only deterministic evaluation verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-120-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-120-HDS-010-SDS-010-SMS-010 construction-only deterministic diagnostics verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-140-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-140-HDS-010-SDS-010-SMS-010 construction-only scoped output boundary verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-150-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-150-HDS-010-SDS-010-SMS-010 construction-only portable meaning verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-150-HDS-010-SDS-020-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-150-HDS-010-SDS-020-SMS-010 construction-only portability comparison verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-160-HDS-010-SDS-010-SMS-010" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-160-HDS-010-SDS-010-SMS-010 construction-only portability limitation verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-166-HDS-010-SDS-010-SMS-900" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-166-HDS-010-SDS-010-SMS-900 construction-only renderer-entry source-map verifier; child rows FS-166-HDS-010-SDS-010-SMS-901 through FS-166-HDS-010-SDS-010-SMS-906 own runtime materialization";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-705-HDS-010-SDS-010-SMS-020" = {
      id = "FS-705-HDS-010-SDS-010-SMS-020";
      traceId = "FS-705-HDS-010-SDS-010-SMS-020";
      rowDirectories = {
        SDS = ../../SDS/FS-705-HDS-010-SDS-010;
        SMS = ../../SMS/FS-705-HDS-010-SDS-010-SMS-020;
        SMT = ../FS-705-HDS-010-SDS-010-SMS-020;
        SIT = ../../SIT/FS-705-HDS-010-SDS-010;
      };
      source = null;
      evidenceLevels = [ "SMT" ];
      evidenceBoundary = "construction-only";
      rendererTarget = null;
      script = "../network-codex-agent/scripts/smt-live-FS-705-HDS-010-SDS-010-SMS-020.sh";
      independent = true;
      aggregateOnly = false;
      scope = "FS-705-HDS-010-SDS-010-SMS-020 construction-only active-lab shim output boundary verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-981-HDS-010-SDS-010-SMS-020" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-981-HDS-010-SDS-010-SMS-020 file-reachability-index construction-only; SMS predicates offline-provable via focused construction test";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-985-HDS-010-SDS-010-SMS-020" = {
      ...
      evidenceLevels = [ "SMT" ];
      rendererTarget = null;
      script = "tests/FS-985-HDS-010-SDS-010-SMS-020-repo-local-test-boundary.sh";
      independent = true;
      aggregateOnly = false;
      scope = "FS-985-HDS-010-SDS-010-SMS-020 repo-local test downstream boundary construction-only; SMS grep-scan predicates offline-provable via focused construction test in network-labs/tests/";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-100-HDS-010-SDS-010-SMS-040" = {
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-100-HDS-010-SDS-010-SMS-040 construction-only provenance redaction verifier";
      maxRuntimeTargets = 0;
    };
    ...
    "FS-560-HDS-010-SDS-010-SMS-050" = {
      id = "FS-560-HDS-010-SDS-010-SMS-050";
      traceId = "FS-560-HDS-010-SDS-010-SMS-050";
      rowDirectories = {
        SDS = ../../SDS/FS-560-HDS-010-SDS-010;
        SMS = ../../SMS/FS-560-HDS-010-SDS-010-SMS-050;
        SMT = ../FS-560-HDS-010-SDS-010-SMS-050;
        SIT = ../../SIT/FS-560-HDS-010-SDS-010;
      };
      source = {
        kind = "intent-source";
        intent = ../FS-560-HDS-010-SDS-010-SMS-050/intent.nix;
      ...
      independent = true;
      aggregateOnly = false;
      scope = "FS-560-HDS-010-SDS-010-SMS-050 protected reservation name publication verifier";
      maxRuntimeTargets = 5;
    };
