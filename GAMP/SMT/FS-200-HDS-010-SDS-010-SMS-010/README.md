...
bash tests/FS-200-HDS-010-SDS-010-SMS-010-shared-service-exposure-boundary.sh
```
...
- `network-compiler/tests/test-FS-200-HDS-010-SDS-010-SMS-010.sh` — PASS at HEAD
