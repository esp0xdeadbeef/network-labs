{
  ...
  evidence = {
    ...
    maxRuntimeTargets = 5;
    scope = "SMT/SIT-only prod-like IPv4 client egress: access-vlan2 -> downstream-selector -> policy -> upstream-selector -> core, real s-router-test-clients endpoint, VLAN4 NAT upstream, no PPPoE dependency";
  };
}
