# SMT Source Stub: FS-800-HDS-010-SDS-030-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-800-HDS-010-SDS-030-SMS-010-hat-intent-inventory-boundary.md`
...
Title slug: `hat-intent-inventory-boundary`
