{
  ...
  evidence = {
    ...
    observedResult = "2026-06-30: offline verifier and live verifier passed. Live s-router-nixos 192.168.1.17 and s-router-clab 192.168.1.19 exposed exactly client-edge, downstream-selector, policy, upstream-selector, and vlan4-client-dhcp-slaac for decision-reason-diagnostic; s-router-test-clients 192.168.1.18 remained client-only with no decision-reason router containers.";
  };
}
