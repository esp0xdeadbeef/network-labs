{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-310-HDS-020-SDS-010-SMS-060/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-310-HDS-020-SDS-010-SMS-060/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-310-HDS-020-SDS-010-SMS-060/inventory-test-clients.nix";
    };
