{
  ...
  evidence = {
    ...
    status = "OK";
    scope = "Lab profile selection metadata: named profile records declare logical layout, default core/provider choice, supported renderer/host targets, required inventory classes, and allowed override fields; seeded negatives exercise missing profile default, ambiguous default layout, repeated default payload, and unapproved override field rejection.";
    sealedNegatives = [
