...
`scripts/live-FS-030-HDS-010-SDS-010-SMS-010.sh`.
...
- `../network-codex-agent/scripts/live-FS-030-HDS-010-SDS-010-SMS-010.sh` passed on `s-router-nixos`, `s-router-clab`, and `s-router-test-clients`.
- Evidence directory:
