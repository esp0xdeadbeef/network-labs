{
  ...
  evidence = {
    ...
    focusedTest = "tests/FS-970-HDS-010-SDS-010-SMS-040.sh";
    liveScript = "../network-codex-agent/scripts/smt-live-FS-970-HDS-010-SDS-010-SMS-040.sh";
    command = "MINI_SMT_OFFLINE_VERIFY=0 bash tests/run-active-lab-mini-smt.sh FS-970-HDS-010-SDS-010-SMS-040";
