{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-982-HDS-010-SDS-010-SMS-070/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-982-HDS-010-SDS-010-SMS-070/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-982-HDS-010-SDS-010-SMS-070/inventory-test-clients.nix";
    };
