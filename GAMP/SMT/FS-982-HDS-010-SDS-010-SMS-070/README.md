# SMT Source Stub: FS-982-HDS-010-SDS-010-SMS-070

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-982-HDS-010-SDS-010-SMS-070-no-oneshot-secret-services.md`
...
Title slug: `no-oneshot-secret-services`
