{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-770-HDS-010-SDS-010-SMS-020/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-770-HDS-010-SDS-010-SMS-020/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-770-HDS-010-SDS-010-SMS-020/inventory-test-clients.nix";
    };
