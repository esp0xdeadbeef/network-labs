# SMT Source Stub: FS-860-HDS-010-SDS-010-SMS-010

Canonical SMS: `network-codex-agent/GAMP/SMS/FS-860-HDS-010-SDS-010-SMS-010-persistent-service-state.md`
...
Title slug: `persistent-service-state`
