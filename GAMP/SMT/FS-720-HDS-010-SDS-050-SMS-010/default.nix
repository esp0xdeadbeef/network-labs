{
  ...
  source = {
    ...
    inventories = {
      clab = "GAMP/SMT/FS-720-HDS-010-SDS-050-SMS-010/inventory-clab.nix";
      nixos = "GAMP/SMT/FS-720-HDS-010-SDS-050-SMS-010/inventory-nixos.nix";
      testClients = "GAMP/SMT/FS-720-HDS-010-SDS-050-SMS-010/inventory-test-clients.nix";
    };
