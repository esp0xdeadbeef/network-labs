...
withSatEspRuntimeTargets (selectorFabricLinkRealization {
  ...
  commonBehaviorSourceBinding = import ./common-behavior-source-binding.nix {
    inventoryPath = "GAMP/HAT/emulated-isp-residential-testnet/inventory-nixos.nix";
    profile = "nixos";
  };
      ...
      s-router-clab = {
        bridgeNetworks = {
          ...
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-b--uplink-isp-a =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-guest--uplink-isp-b =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-work--uplink-isp-b =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-a--uplink-isp-b =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-b--uplink-isp-b =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-host-isp =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-routed-isp =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-a--uplink-testnet-host-isp =
            { };
          stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-b--uplink-testnet-routed-isp =
            { };
          stub-clab-client = { };
          stub-clab-dmz = { };
          stub-clab-guest = { };
      ...
      s-router-nixos = {
        bridgeNetworks = {
          ...
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-isp-a =
            { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-guest--uplink-isp-b = { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-work--uplink-isp-b = { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-isp-b =
            { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-isp-b =
            { };
          ...
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-management--uplink-testnet-routed-isp =
            { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-testnet-host-isp =
            { };
          br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-testnet-routed-isp =
            { };
          client = {
            mode = "vlan";
            parent = "eth0";
      ...
      esp0xdeadbeef-site-a-nixos-core-bgp-uplink-isp-b = {
        ...
        ports = {
          ...
          p2p-nixos-core-bgp-uplink-isp-b-nixos-upstream-selector = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-core-bgp-uplink-isp-b-nixos-upstream-selector";
              kind = "bridge";
            };
            interface = {
              name = "ens82";
      ...
      esp0xdeadbeef-site-a-nixos-policy = {
        ...
        ports = {
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-guest--uplink-isp-b = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-guest--uplink-isp-b";
              kind = "bridge";
            };
            interface = {
              name = "ens41";
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-work--uplink-isp-b = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-access-work--uplink-isp-b";
              kind = "bridge";
            };
            interface = {
              name = "ens42";
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-isp-b = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-isp-b";
              kind = "bridge";
            };
            interface = {
              name = "ens43";
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-isp-b = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-isp-b";
              kind = "bridge";
            };
            interface = {
              name = "ens44";
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-testnet-host-isp = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-a--uplink-testnet-host-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens39";
          ...
          p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-testnet-routed-isp = {
            ...
            attach = {
              bridge = "br-site-a-p2p-nixos-policy-nixos-upstream-selector--access-nixos-provider-handoff-access-b--uplink-testnet-routed-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens40";
      ...
      esp0xdeadbeef-site-b-clab-core-bgp-uplink-isp-b = {
        ...
        ports = {
          ...
          p2p-clab-core-bgp-uplink-isp-b-clab-upstream-selector = {
            ...
            attach = {
              bridge = "stub-clab-br-site-b-p2p-clab-core-bgp-uplink-isp-b-clab-upstream-selector";
              kind = "bridge";
            };
            interface = {
              name = "ens82";
      ...
      esp0xdeadbeef-site-b-clab-policy = {
        ...
        ports = {
          ...
          p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-host-isp = {
            ...
            attach = {
              bridge = "stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-host-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens37";
          ...
          p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-routed-isp = {
            ...
            attach = {
              bridge = "stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-access-management--uplink-testnet-routed-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens38";
          ...
          p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-a--uplink-testnet-host-isp = {
            ...
            attach = {
              bridge = "stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-a--uplink-testnet-host-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens39";
          ...
          p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-b--uplink-testnet-routed-isp = {
            ...
            attach = {
              bridge = "stub-clab-br-site-b-p2p-clab-policy-clab-upstream-selector--access-clab-provider-handoff-access-b--uplink-testnet-routed-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens40";
