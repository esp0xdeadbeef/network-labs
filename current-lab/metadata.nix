{
  layer = "SMT";
  selector = "FS-470-HDS-010-SDS-010-SMS-010__mini-wireguard-remote-egress";
  ...
  selectedBy = "scripts/select-current-lab.sh SMT FS-470-HDS-010-SDS-010-SMS-010__mini-wireguard-remote-egress";
}
