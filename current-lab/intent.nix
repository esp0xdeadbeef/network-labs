...
rec {
  activeLabConstructionOnly = {
    ...
    note = "This active-lab selection has no runtime topology. Run tests/run-active-lab-mini-smt.sh FS-150-HDS-010-SDS-010-SMS-010 for the owning construction check.";
  };
