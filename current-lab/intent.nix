...
rec {
  activeLabConstructionOnly = {
    ...
    rowDirectory = ../GAMP/SMT/FS-500-HDS-010-SDS-010-SMS-050;
    evidenceBoundary = "construction-only";
    note = "This active-lab selection has no runtime topology. Run tests/run-active-lab-mini-smt.sh FS-500-HDS-010-SDS-010-SMS-050 for the owning construction check.";
  };
