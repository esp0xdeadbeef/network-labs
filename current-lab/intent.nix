...
rec {
  activeLabConstructionOnly = {
    ...
    rowDirectory = ../GAMP/SMT/FS-310-HDS-010-SDS-010-SMS-010;
    evidenceBoundary = "construction-only";
    note = "This active-lab selection has no runtime topology. Run tests/run-active-lab-mini-smt.sh FS-310-HDS-010-SDS-010-SMS-010 for the owning construction check.";
  };
