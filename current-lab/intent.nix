...
rec {
  activeLabConstructionOnly = {
    ...
    rowDirectory = ../GAMP/SMT/FS-630-HDS-010-SDS-010-SMS-040;
    evidenceBoundary = "construction-only";
    note = "This active-lab selection has no runtime topology. Run tests/run-active-lab-mini-smt.sh FS-630-HDS-010-SDS-010-SMS-040 for the owning construction check.";
  };
