...
rec {
  activeLabConstructionOnly = {
    ...
    note = "This active-lab selection has no runtime topology. Run tests/run-active-lab-mini-smt.sh FS-720-HDS-040-SDS-010-SMS-020 for the owning construction check.";
  };
