#!/usr/bin/env bash
# GAMP-ID: FS-982-HDS-010-SDS-010-SMS-040
...
intent_file="${repo_root}/GAMP/SMT/FS-982-HDS-010-SDS-010-SMS-040/intent.nix"
trace_id="FS-982-HDS-010-SDS-010-SMS-040"
...
nix eval --impure --expr "
  let
    ...
    lab = intent.\"mini-smt\".\"fs_982_hds_010_sds_010_sms_040\";
  ...
  in
    ...
    && require (relations != [ ] && (builtins.head relations).id == \"FS-982-HDS-010-SDS-010-SMS-040__mini-client-to-testnet\")
...
echo "SMS predicate verification for FS-982-HDS-010-SDS-010-SMS-040 is in the owning repo construction test."
