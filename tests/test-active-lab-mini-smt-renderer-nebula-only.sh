...
in
  ...
  && require (overlay.runtimeNodes.lab-lighthouse.service.listenHost == "0.0.0.0") "nebula lighthouse listen host mismatch"
  ...
  && require (overlay.runtimeNodes.lab-client-nebula.service.listenHost == "0.0.0.0") "nebula client listen host mismatch"
  && require (overlay.runtimeNodes.lab-client-nebula.service.port == 4242) "nebula client listen port mismatch"
  && require ((overlay.nebula.runtimeNodes.lab-client-nebula.unsafeRoutes or [ ]) == [ ]) "nebula renderer-entry row must not inject unsafe payload routes"
  ...
  && require (result.nodes.lab-client-nebula.unsafeRoutes == [ ]) "nebula client runtime plan must not include unsafe routes in renderer-entry row"
  && require (lighthouseRuntimeModule.services.nebula.networks.runtime.listen.host == "0.0.0.0") "nebula lighthouse runtime module listen host mismatch"
  ...
  && require (clientRuntimeModule.services.nebula.networks.runtime.listen.host == "0.0.0.0") "nebula client runtime module listen host mismatch"
  ...
  && require ((clientRuntimeModule.services.nebula.networks.runtime.tun.unsafe_routes or [ ]) == [ ]) "nebula client runtime module must not emit unsafe_routes"
