...
intent_file="${repo_root}/GAMP/SMT/FS-650-HDS-010-SDS-010-SMS-040/intent.nix"
trace_id="FS-650-HDS-010-SDS-010-SMS-040"
...
nix eval --impure --expr "
  let
    ...
    lab = intent.\"mini-smt\".\"FS-650-HDS-010-SDS-010-SMS-040\";
  ...
  in
    ...
    && require (relations != [ ] && (builtins.head relations).id == \"FS-650-HDS-010-SDS-010-SMS-040__mini-verify\")
      \"P5 FAIL: relation ID mismatch or empty relations\"
    && require (builtins.any (r: r.action == \"allow\") relations)
      \"P6 FAIL: allow relation missing\"
...
echo "SMS predicate verification for FS-650-HDS-010-SDS-010-SMS-040 is in the owning repo construction test."
