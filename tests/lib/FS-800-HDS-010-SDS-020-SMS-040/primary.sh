...
echo "  network-control-plane-model/tests/FS-800-HDS-010-SDS-020-SMS-040.sh"
echo ""
echo "SMS Validation Evidence Boundary: split."
echo "Live-required predicates are covered by the focused SIT probe:"
echo "  ../network-codex-agent/scripts/live-FS-800-HDS-010-SDS-020-SMS-040.sh --live"
echo ""
