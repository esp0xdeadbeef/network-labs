...
nixos_test="${nixos_renderer}/tests/test-FS-500-HDS-010-SDS-010-SMS-050-nixos-bridge-colocation.sh"
...
clab_test="${clab_renderer}/tests/test-FS-500-HDS-010-SDS-010-SMS-050-clab-bridge-colocation.sh"
if [ -f "$clab_test" ]; then
