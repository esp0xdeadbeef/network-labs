...
intent_file="${repo_root}/GAMP/SMT/FS-590-HDS-010-SDS-010-SMS-040/intent.nix"
trace_id="FS-590-HDS-010-SDS-010-SMS-040"
...
nix eval --impure --expr "
  let
    ...
    lab = intent.\"mini-smt\".\"FS-590-HDS-010-SDS-010-SMS-040\";
...
echo "9/9 structural predicates PASS"
echo ""
echo "NOTE: This is a structural validation of the row-local intent fixture only."
echo "SMS predicate verification for FS-590-HDS-010-SDS-010-SMS-040 is in the owning repo construction test."
