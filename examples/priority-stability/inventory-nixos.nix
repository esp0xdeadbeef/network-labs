      ...
      esp0xdeadbeef-site-stable-s-router-downstream-selector = {
        ...
        ports = {
          ...
          policy-access-admin = {
            ...
            attach = {
              bridge = "br-site-stable-downstream-policy-access-admin";
              kind = "bridge";
            };
            interface = {
              name = "ens4";
          ...
          policy-access-clients = {
            ...
            attach = {
              bridge = "br-site-stable-downstream-policy-access-clients";
              kind = "bridge";
            };
            interface = {
              name = "ens5";
          ...
          policy-access-mgmt = {
            ...
            attach = {
              bridge = "br-site-stable-downstream-policy-access-mgmt";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
      ...
      esp0xdeadbeef-site-stable-s-router-policy = {
        ...
        ports = {
          ...
          upstream-access-admin-wan = {
            ...
            attach = {
              bridge = "br-site-stable-policy-upstream-access-admin-wan";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
