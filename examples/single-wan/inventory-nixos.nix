      ...
      esp0xdeadbeef-site-a-s-router-downstream-selector = {
        ...
        ports = {
          ...
          policy-access-admin = {
            ...
            attach = {
              bridge = "br-loop-site-a-downstream-policy-access-admin";
              kind = "bridge";
            };
            interface = {
              name = "ens4";
          ...
          policy-access-client = {
            ...
            attach = {
              bridge = "br-loop-site-a-downstream-policy-access-client";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
          ...
          policy-access-mgmt = {
            ...
            attach = {
              bridge = "br-loop-site-a-downstream-policy-access-mgmt";
              kind = "bridge";
            };
            interface = {
              name = "ens5";
      ...
      esp0xdeadbeef-site-a-s-router-policy = {
        ...
        ports = {
          ...
          upstream-access-admin-wan = {
            ...
            attach = {
              bridge = "br-loop-site-a-policy-upstream-access-admin-wan";
              kind = "bridge";
            };
            interface = {
              name = "ens4";
          ...
          upstream-access-client-wan = {
            ...
            attach = {
              bridge = "br-loop-site-a-policy-upstream-access-client-wan";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
          ...
          upstream-access-mgmt-wan = {
            ...
            attach = {
              bridge = "br-loop-site-a-policy-upstream-access-mgmt-wan";
              kind = "bridge";
            };
            interface = {
              name = "ens5";
