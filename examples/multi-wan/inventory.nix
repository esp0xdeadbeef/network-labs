    ...
    hosts = {
      lab-host = {
        ...
        bridgeNetworks = {
          ...
          br-site-b-policy-upstream-access-isp-a = { };
          br-site-b-policy-upstream-access-isp-b = { };
    ...
    nodes = {
      esp0xdeadbeef-site-a-s-router-core-isp-a = {
        ...
        ports = {
          upstream-selector = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-core-isp-a-upstream-selector";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-a-s-router-core-isp-b = {
        ...
        ports = {
          upstream-selector = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-core-isp-b-upstream-selector";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-a-s-router-upstream-selector = {
        ...
        ports = {
          core-isp-a = {
            link = "p2p-s-router-core-isp-a-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-upstream-selector-core-isp-a";
            attach = {
              kind = "bridge";
              bridge = "br-site-a-core-isp-a-upstream";
            };
          ...
          core-isp-b = {
            link = "p2p-s-router-core-isp-b-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-upstream-selector-core-isp-b";
            attach = {
              kind = "bridge";
              bridge = "br-site-a-core-isp-b-upstream";
            };
          ...
          policy-access-adm-isp-a = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-upstream-selector-policy-access-adm-isp-a";
            attach.kind = "bridge";
          ...
          policy-access-adm-isp-b = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-upstream-selector-policy-access-adm-isp-b";
            attach.kind = "bridge";
          ...
          policy-access-mgmt-isp-a = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-upstream-selector-policy-access-mgmt-isp-a";
            attach.kind = "bridge";
      ...
      esp0xdeadbeef-site-a-s-router-policy = {
        ...
        ports = {
          upstream-access-adm-isp-a = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access-adm--uplink-isp-a";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-policy-upstream-access-adm-isp-a";
            attach.kind = "bridge";
            attach.bridge = "br-site-a-policy-upstream-access-adm-isp-a";
            interface.name = "ens3";
          };
          ...
          upstream-access-adm-isp-b = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access-adm--uplink-isp-b";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-policy-upstream-access-adm-isp-b";
            attach.kind = "bridge";
            attach.bridge = "br-site-a-policy-upstream-access-adm-isp-b";
            interface.name = "ens4";
          };
          ...
          upstream-access-mgmt-isp-a = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access-mgmt--uplink-isp-a";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-policy-upstream-access-mgmt-isp-a";
            attach.kind = "bridge";
            attach.bridge = "br-site-a-policy-upstream-access-mgmt-isp-a";
            interface.name = "ens5";
          };
          ...
          downstream-access-adm = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-policy-downstream-access-adm";
            attach.kind = "bridge";
      ...
      esp0xdeadbeef-site-a-s-router-downstream-selector = {
        ...
        ports = {
          policy-access-adm = {
            link = "p2p-s-router-downstream-selector-s-router-policy--access-s-router-access-adm";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-downstream-selector-policy-access-adm";
            attach.kind = "bridge";
            attach.bridge = "br-site-a-downstream-policy-access-adm";
            interface.name = "ens3";
          };
          ...
          access-adm = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-downstream-selector-access-adm";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-a-s-router-access-adm = {
        ...
        ports = {
          transit-downstream-selector = {
            link = "p2p-s-router-access-adm-s-router-downstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-a-s-router-access-adm-transit-downstream-selector";
            attach = {
              kind = "bridge";
              bridge = "br-site-a-downstream-adm";
            };
      ...
      esp0xdeadbeef-site-b-s-router-core-isp-a = {
        ...
        ports = {
          upstream-selector = {
            link = "p2p-s-router-core-isp-a-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-core-isp-a-upstream-selector";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-b-s-router-core-isp-b = {
        ...
        ports = {
          upstream-selector = {
            link = "p2p-s-router-core-isp-b-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-core-isp-b-upstream-selector";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-b-s-router-upstream-selector = {
        ...
        ports = {
          core-isp-a = {
            link = "p2p-s-router-core-isp-a-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-upstream-selector-core-isp-a";
            attach = {
              kind = "bridge";
              bridge = "br-site-b-core-isp-a-upstream";
            };
          ...
          core-isp-b = {
            link = "p2p-s-router-core-isp-b-s-router-upstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-upstream-selector-core-isp-b";
            attach = {
              kind = "bridge";
              bridge = "br-site-b-core-isp-b-upstream";
            };
          ...
          policy-access-isp-a = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access--uplink-isp-a";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-upstream-selector-policy-access-isp-a";
            attach.kind = "bridge";
            attach.bridge = "br-site-b-policy-upstream-access-isp-a";
            interface.name = "ens15";
          };

          policy-access-isp-b = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access--uplink-isp-b";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-upstream-selector-policy-access-isp-b";
            attach.kind = "bridge";
            attach.bridge = "br-site-b-policy-upstream-access-isp-b";
      ...
      esp0xdeadbeef-site-b-s-router-policy = {
        ...
        ports = {
          upstream-access-isp-a = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access--uplink-isp-a";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-policy-upstream-access-isp-a";
            attach.kind = "bridge";
            attach.bridge = "br-site-b-policy-upstream-access-isp-a";
            interface.name = "ens13";
          };

          upstream-access-isp-b = {
            link = "p2p-s-router-policy-s-router-upstream-selector--access-s-router-access--uplink-isp-b";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-policy-upstream-access-isp-b";
            attach.kind = "bridge";
            attach.bridge = "br-site-b-policy-upstream-access-isp-b";
          ...
          downstream-access = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-policy-downstream-access";
            attach.kind = "bridge";
      ...
      esp0xdeadbeef-site-b-s-router-downstream-selector = {
        ...
        ports = {
          policy-access = {
            link = "p2p-s-router-downstream-selector-s-router-policy--access-s-router-access";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-downstream-selector-policy-access";
            attach.kind = "bridge";
            attach.bridge = "br-site-b-downstream-policy-access";
            interface.name = "ens13";
          };
          ...
          access = {
            ...
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-downstream-selector-access";
            attach = {
              kind = "bridge";
      ...
      esp0xdeadbeef-site-b-s-router-access = {
        ...
        ports = {
          transit-downstream-selector = {
            link = "p2p-s-router-access-s-router-downstream-selector";
            adapterName = "adp-esp0xdeadbeef-site-b-s-router-access-transit-downstream-selector";
            attach = {
              kind = "bridge";
              bridge = "br-site-b-downstream-access";
            };
