            ...
            east-west = {
              nebula = {
                lighthouse = {
                  ...
                  endpoint6 = "2001:db8:100::102";
                  node = "s-router-core-nebula";
                  port = 4242;
                };
                role = "core-client";
              };
  ...
  deployment = {
    hosts = {
      lab-host = {
        ...
        wanGroupToUplink = {
          "enterprise-a::site-a::s-router-core-wan" = "uplink0";
          "enterprise-b::site-b::s-router-core-wan" = "uplink0";
        };
      };
    };
  };
    ...
    nodes = {
      ...
      enterprise-a-site-a-s-router-downstream-selector = {
        ...
        ports = {
          ...
          policy-access = {
            ...
            attach = {
              bridge = "br-site-a-downstream-policy-access";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
      ...
      enterprise-a-site-a-s-router-policy = {
        ...
        ports = {
          ...
          upstream-access-east-west = {
            ...
            attach = {
              bridge = "br-site-a-policy-upstream-access-east-west";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
          ...
          upstream-access-isp = {
            adapterName = "adp-enterprise-a-site-a-s-router-policy-upstream-access-isp";
            attach = {
              bridge = "br-site-a-policy-upstream-access-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens5";
      ...
      enterprise-a-site-a-s-router-upstream-selector = {
        ...
        ports = {
          ...
          policy-access-isp = {
            adapterName = "adp-enterprise-a-site-a-s-router-upstream-selector-policy-access-isp";
            attach = {
              bridge = "br-site-a-policy-upstream-access-isp";
              kind = "bridge";
            };
      ...
      enterprise-b-site-b-s-router-downstream-selector = {
        ...
        ports = {
          ...
          policy-access = {
            ...
            attach = {
              bridge = "br-site-b-downstream-policy-access";
              kind = "bridge";
            };
            interface = {
              name = "ens13";
      ...
      enterprise-b-site-b-s-router-policy = {
        ...
        ports = {
          ...
          upstream-access-east-west = {
            ...
            attach = {
              bridge = "br-site-b-policy-upstream-access-east-west";
              kind = "bridge";
            };
            interface = {
              name = "ens13";
          ...
          upstream-access-isp = {
            adapterName = "adp-enterprise-b-site-b-s-router-policy-upstream-access-isp";
            attach = {
              bridge = "br-site-b-policy-upstream-access-isp";
              kind = "bridge";
            };
            interface = {
              name = "ens15";
      ...
      enterprise-b-site-b-s-router-upstream-selector = {
        ...
        ports = {
          ...
          policy-access-isp = {
            adapterName = "adp-enterprise-b-site-b-s-router-upstream-selector-policy-access-isp";
            attach = {
              bridge = "br-site-b-policy-upstream-access-isp";
              kind = "bridge";
            };
