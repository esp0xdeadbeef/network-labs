      ...
      esp0xdeadbeef-site-a-s-router-downstream-selector = {
        ...
        ports = {
          ...
          policy-access-adm = {
            ...
            attach = {
              bridge = "br-site-a-downstream-policy-access-adm";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
      ...
      esp0xdeadbeef-site-a-s-router-policy = {
        ...
        ports = {
          ...
          upstream-access-adm-isp-a = {
            ...
            attach = {
              bridge = "br-site-a-policy-upstream-access-adm-isp-a";
              kind = "bridge";
            };
            interface = {
              name = "ens3";
          ...
          upstream-access-adm-isp-b = {
            ...
            attach = {
              bridge = "br-site-a-policy-upstream-access-adm-isp-b";
              kind = "bridge";
            };
            interface = {
              name = "ens4";
