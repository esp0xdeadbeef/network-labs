    ...
    hosts = {
      s-router-clab = {
        ...
        wanGroupToUplink = {
          ...
          "esp0xdeadbeef::site-b::clab-core-bgp-uplink-isp-b" = "uplink-isp-b";
      ...
      s-router-nixos = {
        bridgeNetworks = {
          ...
          stub-nixos-br-site-a-p2p-nixos-core-testnet-host-isp-nixos-provider-handoff-access-a = { };
      ...
      esp0xdeadbeef-site-a-nixos-access-iot = {
        ...
        ports = {
          ...
          p2p-nixos-access-iot-nixos-core-wireguard-host128 = {
            ...
            attach = {
              bridge = "stub-nixos-br-site-a-p2p-nixos-access-iot-nixos-core-wireguard-host128";
              kind = "bridge";
            };
            interface = {
              name = "ens21";
      ...
      esp0xdeadbeef-site-a-nixos-core-testnet-host-isp = {
        ...
        ports = {
          p2p-nixos-core-testnet-host-isp-nixos-provider-handoff-access-a = {
            ...
            attach = {
              bridge = "stub-nixos-br-site-a-p2p-nixos-core-testnet-host-isp-nixos-provider-handoff-access-a";
              kind = "bridge";
            };
            interface = {
              name = "ens20";
